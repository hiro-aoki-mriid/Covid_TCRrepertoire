...
df_search = pd.read_csv("mydata/Metaclonotype_query/bioRxiv_v2_metaclonotypes.tsv", sep = "\t") #Change query file names!!!
...
#Output
fileout = file.replace('.pool.aaVJ.table.txt', '.kmayerb.metaclonotype.csv')
