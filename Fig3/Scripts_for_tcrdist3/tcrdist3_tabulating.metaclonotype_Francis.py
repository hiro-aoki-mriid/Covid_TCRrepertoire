...
df_search = pd.read_csv("mydata/Metaclonotype_query/Francis_metaclonotypes.tsv", sep = "\t") #Change query file names!!!
...
#Output
fileout = file.replace('.pool.aaVJ.table.txt', '.francis.metaclonotype.csv')
