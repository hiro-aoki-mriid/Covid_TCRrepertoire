### Dummarize data for barplot of frequencies of each module (CD8)
...
Tcell <- "CD8" #Whether CD4 or CD8 repertoire is analysed
dir.output <- "1D"
name.output <- "WGCNA.summarize.barplot"
index_array <- c("sum_TP1", "sum_TP2", "sum_TP3", "sum_TP4") #Parameters for summarize 
class_order <- c("singlet", "0", "blue", "invblue", "yellow", "invyellow", "green", "invgreen",
                 "brown", "invbrown", "red", "invred", "turquoise", "invturquoise")
