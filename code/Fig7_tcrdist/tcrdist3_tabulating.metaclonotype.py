...
ncpus = min(multiprocessing.cpu_count(), 12)

#Import VDJtools format
...
df_search = pd.read_csv(query, sep = "\t") #Change query file names!!!
...
#Output
fileout = file.replace('.pool.aaVJ.table.txt', '.metaclonotype.csv')
fileout = fileout.replace('Pool/', nameout)
